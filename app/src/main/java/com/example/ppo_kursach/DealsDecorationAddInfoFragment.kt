...
class DealsDecorationAddInfoFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_deals_decoration_add_info, container, false)
        ...
        view.findViewById<Button>(R.id.add_decoration).setOnClickListener{
            val model = DecorationClass(
                ...
                photoName)
            setFragmentResult(
                "deals_decoration_add_key",
                bundleOf("add_decoration_key" to model)
            )
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            DealsDecorationAddInfoFragment().apply {
